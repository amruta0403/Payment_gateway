...
async def lifespan(app: FastAPI):
    log.info("service.startup", service="upi-service")
    ...
    producer = PaymentEventProducer(settings.KAFKA_BOOTSTRAP_SERVERS, "upi-service")
    try:
    ...
    log.info("service.shutdown", service="upi-service")
