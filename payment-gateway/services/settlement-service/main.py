...
async def lifespan(app: FastAPI):
    log.info("service.startup", service="settlement-service")
    ...
    producer = PaymentEventProducer(settings.KAFKA_BOOTSTRAP_SERVERS, "settlement-service")
    try:
    ...
    log.info("service.ready", service="settlement-service")
    yield
    ...
    log.info("service.shutdown", service="settlement-service")
