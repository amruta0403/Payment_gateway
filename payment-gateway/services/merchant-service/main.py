...
async def lifespan(app: FastAPI):
    log.info("service.startup", service="merchant-service")
    ...
    producer = PaymentEventProducer(settings.KAFKA_BOOTSTRAP_SERVERS, "merchant-service")
    try:
    ...
    log.info("service.shutdown", service="merchant-service")
